({
    ...
    doInit : function(c, e, h) {
        ...
        h.request(c, 'assignVehicleToSalesOrder', {recordId: c.get('v.recordId')}, function(r){
            console.log('assignVehicleToSalesOrder:',r);
    ...
    retrieveVehicleAndRelatedRSMTSMs1: function(c,e,h){        
        h.request(c, 'retrieveVehicleAndRelated', {order: c.get('v.rsmObj'),assignedVehicleId: c.get('v.assignedVehicleId'),assignedVehicleDateStr: c.get('v.assignedVehicleDate')}, function(r){            
            console.log(r);
            c.set('v.rsmObj', r.rsmObj);    
            c.set('v.rsmList', r.rsmList);
            c.set('v.tsmList', r.tsmList);
