({    
    ...
    doInit : function(c, e, h) {
        h.request(c, 'assignVehicleToPurchaseOrder', {recordId: c.get('v.recordId')}, function(r){
    ...
    retrieveVehicleAndRelatedRSMTSMs1: function(c,e,h){
        h.request(c, 'retrieveVehicleAndRelatedRSMLight', {order: c.get('v.rsmObj'),assignedVehicleId: c.get('v.assignedVehicleId'),assignedVehicleDateStr: c.get('v.assignedVehicleDate')}, function(r){
            c.set('v.rsmObj', r.rsmObj);    
            c.set('v.rsmList', r.rsmList);
            c.set('v.tsmList', r.tsmList);
            c.set('v.vehicleObj',r.vehicleObj);
