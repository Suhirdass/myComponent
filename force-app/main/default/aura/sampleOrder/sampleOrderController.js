    ...
    onInit: function (c, e, h) {
        try {
            ...
            h.request(c, 'init', { recordId: c.get('v.recordId'),"fromTransferOrders":false,retailDeliveryTicketData:retailDeliveryTicketClone,retailDeliveryTicketLineItemsData:retailDeliveryTicketLineItemsClone,isClone:isClone }, function (r) {
                ...
                c.set('v.Piggyback_help_text',r.Piggyback_help_text);
                ...
                r.paymentTerms.forEach((fa) => {
                    ...
                    console.log('r.transportLicenses',r.transportLicenses);
                    var contactsOptions = [];
    ...
    onViewBrand:function(c,e,h){
            ...
            totalExciseTax =0;
                        ...
                        showDatePicker: function (c, e, h) {
                            ...
                            calculateServiceFee: function (c, e, h) {
                                ...
                                if(newRetailDeliveryTicket.retailer){
            ...
            updateTicketLineItem: function (c, e, h) {
                ...
                onLicenseChange: function (c, e, h) {
                    ...
                    if (licenseId) {
                        ...
                        newrdt.siteId = statelicenses[licenseId].Default_Warehouse__c;
     ...
     handleTimePickerEvent: function(c, e, h) {
        ...
        c.set('v.'+fieldName,selectedTime);
            ...
            onSave: function (c, e, h) {
                try {
                    ...
                    if(newRetailDeliveryTicket.isPreapproved && newRetailDeliveryTicket.piggybackSample){
                        h.error({ message: 'If Piggyback Sample Order is selected, Preapproved cannot be selected.',}); 
                        return;
                    }
                    ...
                    if(SampleOrderFamilyDetail != null ){
      ...
      if(Sample_Limitation_Error != ''){
                ...
                console.log(newRetailDeliveryTicket.isSample);        
                if(newRetailDeliveryTicket.isSample && !chkAllIsSample){
                	h.error({ message: c.get('v.Err_Msg_all_line_items_as_isSample'),});       
            		return;	        
                }        
                                                    ...
                                                    onProductChange: function (c, e, h) {
                                                        ...
                                                        products.forEach((item) => {
                                                            ...
                                                            */
                                                            ...
                                                            isError= true;
                                                        }else if(qty > item.availableQty  || countSameOdrQty>totalInventry){
                                                            isError= true;	
                                                        }
