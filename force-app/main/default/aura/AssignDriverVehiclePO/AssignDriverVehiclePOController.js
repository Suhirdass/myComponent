({
    ...
    assignDriverVehicleValues : function(c, e, h) {
        ...
        if(c.get('v.rsmObj.Planned_Ship_Transfer_Date__c') == undefined || c.get('v.rsmObj.Planned_Ship_Transfer_Date__c') == null || c.get('v.rsmObj.Planned_Ship_Transfer_Date__c') == 'null'){
            h.showErrorMsg('Error', 'error', c.get('v.Err_Msg_Select_Planned_Transfer_Date'));          
        }
        if((c.get('v.selectedVehicle') != '') && (c.get('v.selectedDriver') != '') && (c.get('v.rsmObj.Planned_Ship_Transfer_Date__c') != undefined && c.get('v.rsmObj.Planned_Ship_Transfer_Date__c') != null && c.get('v.rsmObj.Planned_Ship_Transfer_Date__c') != 'null')){ 
    ...
    onPurchaseOrderClick: function (c, e, h) {
