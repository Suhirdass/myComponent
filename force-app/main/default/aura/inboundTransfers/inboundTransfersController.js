({
    ...
    onPrintSelect: function (c, e, h) {
        ...
        if(selectedFormat == 'csv'){
            ...
            currentUrl = currentUrl.replace('/s/inboundtransfers','/apex/printInboundTransferPdf?fromService=false&filters='+JSON.stringify(c.get('v.filters')));
    ...
    onNewServiceTicket: function (c, e, h) {
        ...
        var screenName = 'Create Inbound Transfer';
