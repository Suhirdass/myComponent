({
    ...
    changeOrder: function (c, e, h) {
        ...
        c.set('v.filters', filters);
        console.log('the filters',c.get('v.filters'));
    ...
    onPrintSelect: function (c, e, h) {
        ...
        if(selectedFormat == 'csv'){
            ...
            currentUrl = currentUrl.replace('/s/brandorders','/apex/printOrdersPdf?showTransferOrders=false&filters='+JSON.stringify(c.get('v.filters')));
