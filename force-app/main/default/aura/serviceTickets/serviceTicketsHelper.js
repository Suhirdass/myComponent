({
    getIds: function (c, filters) {
        ...
        var h = this;
        h.request(c, 'getIds', { filters: filters, fromService: 'true' }, function (r) {
    ...
    getRecordsForFile: function(c, ids) {
        ...
        action.setCallback(this, function(a){
            ...
            if(state == 'SUCCESS') {
                ...
                hiddenElement.download = 'ServiceTicketsData.csv';  // CSV file Name* you can change it.[only name not .csv] 
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords){
        ...
        keys = ['ticketNumber','status','createdDate','transferDateString','brandContact','totalServiceLines','totalCompletedServiceLines'];
        var keys1 = ['Ticket Number','Status','Date Created','Requested Start Date','Brand Contact','Services','Progress'];
