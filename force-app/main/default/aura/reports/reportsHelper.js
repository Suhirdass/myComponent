({
	getIds: function(c, filters) {
        var h = this;
        h.request(c, 'getReportsIds', {filters: filters}, function(r){
            try{
    ...
    getRecordsForFile: function(c, ids) {
        ...
        action.setCallback(this, function(a){
            ...
            if(state == 'SUCCESS') {
                var records = a.getReturnValue().data.records;
                console.log('records ',records);
                var csv = this.convertArrayOfObjectsToCSV(c,records);   
                if (csv == null){return;} 
                ...
                hiddenElement.download = 'Reports.csv';  // CSV file Name* you can change it.[only name not .csv] 
