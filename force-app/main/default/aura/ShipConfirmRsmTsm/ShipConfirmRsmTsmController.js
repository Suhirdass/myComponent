({
    doInit : function(c, e, h) {        
        ...
        h.request(c, 'shipConfirmLight', {selectedDays: datStr}, function(r){

            c.set('v.setShipLines', r.setShipLines);
            console.log('setShipLines', r.setShipLines);
     ...
     var tt = c.find('errormessage');     
        ...
        //  for 101 - reduce number of query execution update BQlin and Order line 
        //  this line will execute while shipconfirm
