function getLazarSoftScanner() {
        ...
        this.buildFunctionPattern = function() {
            ...
            for (var n = this.alignmentPatternCenters.length, r = 0; r < n; r++)
                for (var i = this.alignmentPatternCenters[r] - 2, a = 0; a < n; a++)
                    0 == r && (0 == a || a == n - 1) || r == n - 1 && 0 == a || t.setRegion(this.alignmentPatternCenters[a] - 2, i, 5, 5);
    ...
    function o(t) {
        ...
        this.sizeOfBlackWhiteBlackRun = function(e, t, n, r) {
            ...
            for (var o = Math.abs(n - e), s = Math.abs(r - t), h = -o >> 1, w = t < r ? 1 : -1, f = e < n ? 1 : -1, u = 0, d = e, l = t; d != n; d += f) {
                var c = i ? l : d
                  , g = i ? d : l;
                if (1 == u ? this.image[c + g * A.width] && u++ : this.image[c + g * A.width] || u++,
                3 == u) {
                    var v = d - e
                      , m = l - t;
        ...
        this.sizeOfBlackWhiteBlackRunBothWays = function(e, t, n, r) {
            var i = this.sizeOfBlackWhiteBlackRun(e, t, n, r)
              ...
              , o = e - (n - e);
            o < 0 ? (a = e / (e - o),
            o = 0) : o >= A.width && (a = (A.width - 1 - e) / (o - e),
            o = A.width - 1);
            var s = Math.floor(t - (r - t) * a);
            return a = 1,
            s < 0 ? (a = t / (t - s),
            s = 0) : s >= A.height && (a = (A.height - 1 - t) / (s - t),
            s = A.height - 1),
        ...
        this.createTransform = function(e, t, n, r, a) {
            ...
            return null != r ? (o = r.X,
            s = r.Y,
            h = w = f - 3) : (o = t.X - e.X + n.X,
            s = t.Y - e.Y + n.Y,
            h = w = f),
            i.quadrilateralToQuadrilateral(3.5, 3.5, f, 3.5, h, w, 3.5, f, e.X, e.Y, t.X, t.Y, o, s, n.X, n.Y)
        }
        ,
    ...
    e.sampleGrid3 = function(t, n, r) {
        for (var i = new v(n), a = new Array(n << 1), o = 0; o < n; o++) {
            for (var s = a.length, h = o + .5, w = 0; w < s; w += 2)
                a[w] = .5 + (w >> 1),
                a[w + 1] = h;
            r.transformPoints1(a),
            e.checkAndNudgePoints(t, a);
            try {
                for (w = 0; w < s; w += 2) {
    ...
    function b(e) {
        ...
        this.readFormatInformation = function() {
            ...
            if (this.parsedFormatInfo = w.decodeFormatInformation(e),
        ...
        this.readVersion = function() {
            ...
            if (this.parsedVersion = r.decodeVersionInformation(n),
    ...
    m.getDataBlocks = function(e, t, n) {
        if (e.length != t.TotalCodewords)
            throw "ArgumentException";
        for (var r = t.getECBlocksForLevel(n), i = 0, a = r.getECBlocks(), o = 0; o < a.length; o++)
            i += a[o].Count;
    ...
    function C(e, t) {
        ...
        this.addOrSubtract = function(t) {
            ...
            for (var a = new Array(r.length), o = r.length - n.length, s = 0; s < o; s++)
                a[s] = r[s];
    ...
    function _(e) {
        ...
        var r = new Array(1);
        r[0] = 0,
        this.zero = new C(this,new Array(r));
        var i = new Array(1);
        i[0] = 1,
    ...
    ,
    y.DATA_MASKS = new Array(new function() {
    ...
    p.rsDecoder = new function(e) {
        ...
        this.decode = function(e, t) {
            for (var n = new C(this.field,e), r = new Array(t), i = 0; i < r.length; i++)
                r[i] = 0;
            var a = !0;
            for (i = 0; i < t; i++) {
        ...
        this.findErrorMagnitudes = function(e, t, n) {
            for (var r = t.length, i = new Array(r), a = 0; a < r; a++) {
                for (var o = this.field.inverse(t[a]), s = 1, h = 0; h < r; h++)
                    a != h && (s = this.field.multiply(s, _.addOrSubtract(1, this.field.multiply(t[h], o))));
    ...
    ,
    p.decode = function(e) {
        for (var t = new b(e), n = t.readVersion(), r = t.readFormatInformation().ErrorCorrectionLevel, i = t.readCodewords(), a = m.getDataBlocks(i, n, r), o = 0, s = 0; s < a.length; s++)
    ...
    A.sizeOfDataLengthInfo = [[10, 9, 8, 8], [12, 11, 16, 10], [14, 13, 16, 12]],
    A.callback = null,
    A.vidSuccess = function(e) {
        A.localstream = e,
        A.webkit ? A.video.src = window.webkitURL.createObjectURL(e) : A.moz ? (A.video.mozSrcObject = e,
        A.video.play()) : A.video.src = e,
        A.gUM = !0,
    ...
    A.setWebcam = function(e) {
            ...
            try {
                navigator.mediaDevices.enumerateDevices().then(function(e) {
                    e.forEach(function(e) {
                        console.log("deb1"),
                        "videoinput" === e.kind && e.label.toLowerCase().search("back") > -1 && (n = [{
                            sourceId: e.deviceId
                        }]),
        ...
        t.getUserMedia ? t.getUserMedia({
            video: n,
            audio: !1
        }, A.vidSuccess, A.vidError) : t.webkitGetUserMedia ? (A.webkit = !0,
        t.webkitGetUserMedia({
            video: n,
            audio: !1
        }, A.vidSuccess, A.vidError)) : t.mozGetUserMedia && (A.moz = !0,
        t.mozGetUserMedia({
            video: n,
            audio: !1
        }, A.vidSuccess, A.vidError))
    }
    ,
    A.decode = function(e) {
        if (0 == arguments.length) {
            if (A.canvas_qr2)
                ...
                n = (t = document.getElementById("qr-canvas")).getContext("2d");
        ...
        r.onload = function() {
            ...
            if (null != e) {
                ...
                t.clearRect(0, 0, 320, 240),
                t.drawImage(r, 0, 0, 320, 240)
            }
            ...
            try {
                ...
                return A.result = "Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!",
            ...
            try {
                ...
                console.log(e),
                A.result = "error decoding QR Code"
            }
            null != A.callback && A.callback(A.result)
        }
        ,
    ...
    A.process = function(e) {
        ...
        if (A.debug) {
            for (var r = 0; r < A.height; r++)
                for (var i = 0; i < A.width; i++) {
                    ...
                    A.imagedata.data[a] = (n[i + r * A.width],
                    0),
                    A.imagedata.data[a + 1] = (n[i + r * A.width],
                    0),
        ...
        if (A.debug) {
            for (r = 0; r < s.bits.Height; r++)
                for (i = 0; i < s.bits.Width; i++) {
                    ...
                    A.imagedata.data[a] = (s.bits.get_Renamed(i, r),
                    0),
                    A.imagedata.data[a + 1] = (s.bits.get_Renamed(i, r),
                    0),
        ...
        for (var h = p.decode(s.bits).DataByte, w = "", f = 0; f < h.length; f++)
            for (var u = 0; u < h[f].length; u++)
                w += String.fromCharCode(h[f][u]);
    ...
    A.getMiddleBrightnessPerArea = function(e) {
        ...
        for (var u = new Array(4), d = 0; d < 4; d++)
            u[d] = new Array(4);
        for (o = 0; o < 4; o++)
            for (s = 0; s < 4; s++)
    ...
    A.grayScaleToBitmap = function(e) {
        for (var t = A.getMiddleBrightnessPerArea(e), n = t.length, r = Math.floor(A.width / n), i = Math.floor(A.height / n), a = new ArrayBuffer(A.width * A.height), o = new Uint8Array(a), s = 0; s < n; s++)
            for (var h = 0; h < n; h++)
                for (var w = 0; w < i; w++)
                    for (var f = 0; f < r; f++)
                        o[r * h + f + (i * s + w) * A.width] = e[r * h + f + (i * s + w) * A.width] < t[h][s];
        return o
    }
    ,
    ...
    function D() {
        ...
        this.crossCheckVertical = function(e, t, n, r) {
            for (var i = this.image, a = A.height, o = this.CrossCheckStateCount, s = e; s >= 0 && i[t + s * A.width]; )
                o[2]++,
                s--;
            if (s < 0)
                return NaN;
            for (; s >= 0 && !i[t + s * A.width] && o[1] <= n; )
                o[1]++,
                s--;
            if (s < 0 || o[1] > n)
                return NaN;
            for (; s >= 0 && i[t + s * A.width] && o[0] <= n; )
                o[0]++,
                s--;
            if (o[0] > n)
                return NaN;
            for (s = e + 1; s < a && i[t + s * A.width]; )
                o[2]++,
                s++;
            if (s == a)
                return NaN;
            for (; s < a && !i[t + s * A.width] && o[3] < n; )
                o[3]++,
                s++;
            if (s == a || o[3] >= n)
                return NaN;
            for (; s < a && i[t + s * A.width] && o[4] < n; )
                o[4]++,
                s++;
            if (o[4] >= n)
                return NaN;
        ...
        this.crossCheckHorizontal = function(e, t, n, r) {
            for (var i = this.image, a = A.width, o = this.CrossCheckStateCount, s = e; s >= 0 && i[s + t * A.width]; )
                o[2]++,
                s--;
            if (s < 0)
                return NaN;
            for (; s >= 0 && !i[s + t * A.width] && o[1] <= n; )
                o[1]++,
                s--;
            if (s < 0 || o[1] > n)
                return NaN;
            for (; s >= 0 && i[s + t * A.width] && o[0] <= n; )
                o[0]++,
                s--;
            if (o[0] > n)
                return NaN;
            for (s = e + 1; s < a && i[s + t * A.width]; )
                o[2]++,
                s++;
            if (s == a)
                return NaN;
            for (; s < a && !i[s + t * A.width] && o[3] < n; )
                o[3]++,
                s++;
            if (s == a || o[3] >= n)
                return NaN;
            for (; s < a && i[s + t * A.width] && o[4] < n; )
                o[4]++,
                s++;
            if (o[4] >= n)
                return NaN;
        ...
        this.handlePossibleCenter = function(e, t, n) {
            ...
            if (!isNaN(a) && (i = this.crossCheckHorizontal(Math.floor(i), Math.floor(a), e[2], r),
            !isNaN(i))) {
                ...
                if (!s) {
                    ...
                    null != this.resultPointCallback && this.resultPointCallback.foundPossibleResultPoint(u)
                }
                return !0
            }
            return !1
    ...
    function F(e, t, n, r, i, a, o) {
        ...
        this.crossCheckVertical = function(e, t, n, r) {
            ...
            if (o[0] > n)
                return NaN;
            for (s = e + 1; s < a && i[t + s * A.width] && o[1] <= n; )
                o[1]++,
                s++;
            if (s == a || o[1] > n)
                return NaN;
            for (; s < a && !i[t + s * A.width] && o[2] <= n; )
                o[2]++,
                s++;
            if (o[2] > n)
                return NaN;
        ...
        this.handlePossibleCenter = function(e, t, n) {
            ...
            if (!isNaN(a)) {
                ...
                null != this.resultPointCallback && this.resultPointCallback.foundPossibleResultPoint(w)
            }
            return null
        }
        ,
        this.find = function() {
            for (var t = this.startX, i = this.height, a = t + r, o = n + (i >> 1), s = new Array(0,0,0), h = 0; h < i; h++) {
                ...
                if (this.foundPatternCross(s))
                    if (null != (d = this.handlePossibleCenter(s, w, a)))
                        return d
            }
    ...
    function I(e, t, n) {
        ...
        this.getNextBits = function(e) {
            ...
            if (e < this.bitPointer + 1 + 16) {
                ...
                this.blockPointer++;
                for (r = 0; r < e - (this.bitPointer + 1 + 8); r++)
                    a += 1 << r;
                return a <<= 8 - (e - (this.bitPointer + 1 + 8)),
        ...
        this.getFigureString = function(e) {
            var t = e
              ...
              , r = "";
            do {
                t >= 3 ? ((n = this.getNextBits(10)) < 100 && (r += "0"),
                n < 10 && (r += "0"),
                t -= 3) : 2 == t ? ((n = this.getNextBits(7)) < 10 && (r += "0"),
        ...
        this.__defineGetter__("DataByte", function() {
            for (var e = new Array; ; ) {
                ...
                if (1 != t && 2 != t && 4 != t && 8 != t && 7 != t)
                    throw "Invalid mode: " + t + " in (block:" + this.blockPointer + " bit:" + this.bitPointer + ")";
                if (7 == t)
                    var n = this.parseECIValue();
                else {
                    var r = this.getDataLength(t);
                    if (r < 1)
                        throw "Invalid data length: " + r;
                    switch (t) {
                    case 1:
                        for (var i = this.getFigureString(r), a = new Array(i.length), o = 0; o < i.length; o++)
                            a[o] = i.charCodeAt(o);
                        e.push(a);
                        break;
                    case 2:
                        for (i = this.getRomanAndFigureString(r),
    ...
    return A.orderBestPatterns = function(e) {
        ...
        var n, r, i, a = t(e[0], e[1]), o = t(e[1], e[2]), s = t(e[0], e[2]);
        if (o >= a && o >= s ? (r = e[0],
        n = e[1],
        i = e[2]) : s >= o && s >= a ? (r = e[1],
        n = e[0],
...
var Html5Qrcode = function() {
    function a(b, c) {
        ...
        if (this.qrcode = getLazarSoftScanner(),
        !this.qrcode)
    ...
    return _createClass(a, [{
        ...
        value: function(b, c, d, e) {
            ...
            var o = function(a, b) {
              ...
              , p = function() {
                try {
                    return g.qrcode.decode(),
                    f._possiblyUpdateShaders(!0),
                    !0
                } catch (a) {
                    return f._possiblyUpdateShaders(!1),
              ...
              , q = function b() {
                if (g._shouldScan) {
                    if (g._localMediaStream) {
                        ...
                        p() || !0 === h.disableFlip || (f._context.translate(f._context.canvas.width, 0),
              ...
              , r = function(a) {
                return new Promise(function(b, c) {
                    ...
                    j || !h.aspectRatio)
                        ...
                        i.applyConstraints(e).then(function() {
                            return d()
                        })["catch"](function(a) {
                            console.log("[Warning] [Html5Qrcode] Constriants could not be satisfied, ignoring constraints", a),
                            d()
                        })
                    }
                }
            ...
            return new Promise(function(a, c) {
                if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                    ...
                    c("Web camera streaming not supported by the browser.")
            }
            )
        }
    }, {
        ...
        value: function(b, c) {
            ...
            var e = function b(c, d, e, f) {
                ...
                d > f && (c = f / d * c,
                d = f),
                a._log("Image downsampled from " + "".concat(i, "X").concat(j) + " to ".concat(c, "X").concat(d, ".")),
                b(c, d, e, f)
            };
        ...
        value: function(a) {
            ...
            return new Promise(function(c, d) {
                if ("aspectRatio"in a)
                    return void d("Chaning 'aspectRatio' in run-time is not yet supported.");
                var e = b._localMediaStream.getVideoTracks()[0];
                e.applyConstraints(a).then(function(a) {
                    c(a)
                })["catch"](function(a) {
                    d(a)
                })
        ...
        value: function(a, b, c) {
            ...
            return d.style.width = "".concat(a, "px"),
        ...
        value: function(a) {
            ...
            return b.style.width = "".concat(a, "px"),
            b.muted = !0,
            b.playsInline = !0,
            b
        }
        ...
        value: function() {
            this._lastScanImageFile && (URL.revokeObjectURL(this._lastScanImageFile),
        ...
        value: function(b) {
            if (!b)
                return a._logError("Empty videoConstraints", !0),
                !1;
            if ("object" !== _typeof(b)) {
                var c = _typeof(b);
                return a._logError("videoConstraints should be of type object, the " + "object passed is of type ".concat(c, "."), !0),
                !1
            }
            for (var d, e = ["autoGainControl", "channelCount", "echoCancellation", "latency", "noiseSuppression", "sampleRate", "sampleSize", "volume"], f = new Set(e), g = Object.keys(b), h = 0; h < g.length; h++)
                if (d = g[h],
                f.has(d))
                    return a._logError("".concat(d, " is not supported videoConstaints."), !0),
                    !1;
            return !0
        }
    }], [{
            ...
            return new Promise(function(b, c) {
                if (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && navigator.mediaDevices.getUserMedia)
                    ...
                    navigator.mediaDevices.getUserMedia({
                        ...
                        ;
                        var e = function(a) {
                            for (var b, c = a.getVideoTracks(), d = 0; d < c.length; d++)
                                b = c[d],
                                b.enabled = !1,
                                b.stop(),
                                a.removeTrack(b)
                    ...
                    var d = function(c) {
                        ...
                        a._log("".concat(e.length, " results found")),
                        b(e)
                    };
...
var Html5QrcodeScanner = function() {
    ...
    return _createClass(a, [{
        ...
        value: function(b, c) {
            ...
            this.qrCodeSuccessCallback = function(c) {
                if (d.__setStatus("MATCH", a.STATUS_SUCCESS),
                b)
                    b(c);
                else {
                    if (d.lastMatchFound == c)
                        return;
                    d.lastMatchFound = c,
                    d.__setHeaderMessage("Last Match: ".concat(c), a.STATUS_SUCCESS)
                }
            }
            ,
            this.qrCodeErrorCallback = function(a) {
                d.__setStatus("Scanning"),
                c && c(a)
            }
            ;
        ...
        value: function() {
            ...
            e.style.display = this.currentScanType == a.SCAN_TYPE_CAMERA ? "block" : "none",
            e.style.width = "100%",
            d.appendChild(e);
            var f = document.createElement("div");
            ...
            g.addEventListener("click", function() {
                ...
                Html5Qrcode.getCameras().then(function(c) {
                    ...
                    c && 0 != c.length ? (e.removeChild(f),
                    b.__renderCameraSelection(c)) : b.__setStatus("No Cameras", a.STATUS_WARNING)
                })["catch"](function(c) {
                    g.disabled = !1,
                    b.__setStatus("IDLE"),
            ...
            h.style.display = this.currentScanType == a.SCAN_TYPE_CAMERA ? "none" : "block",
            d.appendChild(h);
    ...
    
    {
        ...
        value: function(b) {
            ...
            o.addEventListener("click", function() {
                o.disabled = !0,
                c.html5Qrcode.stop().then(function() {
                    c._showHideScanTypeSwapLink(!0),
                    f.disabled = !1,
                    n.disabled = !1,
                    o.style.display = "none",
    ...
    
    {
        ...
        value: function() {
            ...
            g.addEventListener("click", function() {
                return b.sectionSwapAllowed ? void (b.__setStatus("IDLE"),
                b.__resetHeaderMessage(),
                b.__getFileScanInput().value = "",
                b.sectionSwapAllowed = !1,
                b.currentScanType == a.SCAN_TYPE_CAMERA ? (b.__clearScanRegion(),
                ...
                b.__insertFileScanImageToScanRegion()) : (b.__clearScanRegion(),
                ...
                b.sectionSwapAllowed = !0) : void (b.verbose && console.error("Section swap called when not allowed"))
            }),
            f.appendChild(g),
            e.appendChild(f)
        }
        ...
        value: function(a) {
            ...
            this.__getDashboardSectionSwapLink().style.display = a ? "inline-block" : "none"
        }
    }, {
        ...
        value: function() {
            ...
            return this.cameraScanImage ? (c.innerHTML = "<br>",
            void c.appendChild(this.cameraScanImage)) : void (this.cameraScanImage = new Image,
            ...
            this.cameraScanImage.style.opacity = .3,
        ...
        value: function() {
            var b = this
              , c = document.getElementById(this.__getScanRegionId());
            return this.fileScanImage ? (c.innerHTML = "<br>",
            void c.appendChild(this.fileScanImage)) : void (this.fileScanImage = new Image,
            ...
            this.fileScanImage.style.opacity = .3,
